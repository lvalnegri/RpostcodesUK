#' Extract Postcode Units from addresses
#' 
#' Given a data.table with a column containing allegedly addresses, it returns a column of PostCode Units
#'
#' @param x A data.table containing a column with texts that should correspond to addresses  containing a valid British Postcode Unit 
#'
...
#' @export
#'
pcu_from_coords <- function(x_lon, y_lat){

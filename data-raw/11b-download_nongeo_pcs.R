########################################################################
# UK GEOGRAPHY * 11 - DOWNLOAD LIST NON GEOGRAPHICAL POSTCODES SECTORS #
########################################################################
# Unfortunately since Royal Mail has been privatized this pdf file is not available any more

Rfuns::load_pkgs('data.table', 'tabulizer')
...
fwrite(ng[order(PCS)], './data-raw/csv/pcs_non_geo.csv')
